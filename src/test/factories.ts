...
export function createMockQuestionnaireData(
  ...
  return {
    roleSummary: "I build product and engineering teams.",
    archetype: "builder",
    teamQualities: ["problem-solving", "collaboration"],
    growthArea: "executive storytelling",
    talkTopic: "AI adoption in regulated industries",
    personalInterest: "trail running and sci-fi",
    personalityTags: ["planner", "early-bird"],
    joyTrigger: "A quiet coffee before the day starts",
    threeWords: "Curious, direct, dependable",
    headline: "Here to learn, connect, and challenge assumptions",
    funFact: "Once won a hackathon with a spreadsheet-only prototype",
    ...overrides,
  };
}
