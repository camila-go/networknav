  ...
  describe("GET /api/matches", () => {
    ...
    it("should return cached matches on second call", async () => {
      ...
      const cachedMatches = [{
        ...
        matchedUser: {
          id: "cached-match",
          profile: { name: "Cached Match", title: "CEO" },
          questionnaireCompleted: true,
        },
    ...
    it("should force regenerate when refresh=true", async () => {
      ...
      userMatches.set("user-1", [{
        ...
        matchedUser: {
          id: "old-user",
          profile: { name: "Old Match", title: "CTO" },
          questionnaireCompleted: true,
        },
      ...
      userMatches.set("user-1", [
        {
          ...
          userId: "user-1",
          matchedUserId: "u2",
          matchedUser: { id: "u2", profile: { name: "Active", title: "VP" }, questionnaireCompleted: true },
          type: "high-affinity" as const,
          commonalities: [],
          conversationStarters: [],
          score: 0.9,
        ...
        },
        {
          ...
          userId: "user-1",
          matchedUserId: "u3",
          matchedUser: { id: "u3", profile: { name: "Passed", title: "CTO" }, questionnaireCompleted: true },
          type: "strategic" as const,
          commonalities: [],
          conversationStarters: [],
          score: 0.7,
